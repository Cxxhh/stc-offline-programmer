...
)
{
    ...
    // === 2. 配置RX DMA (Channel 1: SPI1_RX) ===
    LL_DMA_SetMemoryAddress(DMA1, LL_DMA_CHANNEL_1, rx_addr);
    ...
    // === 3. 配置TX DMA (Channel 2: SPI1_TX) ===
    LL_DMA_SetMemoryAddress(DMA1, LL_DMA_CHANNEL_2, tx_addr);
    ...
    // === 6. 使能DMA中断 ===
    LL_DMA_EnableIT_TC(DMA1, LL_DMA_CHANNEL_1);  // RX传输完成中断
    LL_DMA_EnableIT_TE(DMA1, LL_DMA_CHANNEL_1);  // RX传输错误中断
    LL_DMA_EnableIT_TC(DMA1, LL_DMA_CHANNEL_2);  // TX传输完成中断
    LL_DMA_EnableIT_TE(DMA1, LL_DMA_CHANNEL_2);  // TX传输错误中断
    ...
    LL_DMA_EnableChannel(DMA1, LL_DMA_CHANNEL_1);  // RX
    LL_DMA_EnableChannel(DMA1, LL_DMA_CHANNEL_2);  // TX
